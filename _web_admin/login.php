...
function __autoload($class_name){
	require_once 'class/sec/LogonAdmin.php';
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	//aqui instanciamos um objeto da classe LogonAdmin e atribuimos sua referencia a $LogonAdmin
	$LogonAdmin = new LogonAdmin();
	...
	if ($LogonAdmin->validarLogin($login, $pass)){
